...
import io.bobba.poc.communication.incoming.generic.*;
...
public class GameClientMessageHandler {
    ...
    private final static int HIGHEST_MESSAGE_ID = 25;
    ...
    private void registerRequests() {
        ...
        requestHandlers[ClientOpCodes.REQUEST_ITEM_REMOVE] = new RequestItemPickUp();
        requestHandlers[ClientOpCodes.REQUEST_ITEM_INTERACT] = new RequestFurniInteract();
        requestHandlers[ClientOpCodes.REQUEST_ITEM_MOVE] = new RequestItemMove();
        requestHandlers[ClientOpCodes.REQUEST_CHANGE_MOTTO] = new RequestChangeMotto();
        requestHandlers[ClientOpCodes.REQUEST_INVENTORY_ITEMS] = new RequestInventoryItems();
        requestHandlers[ClientOpCodes.REQUEST_ITEM_PLACE] = new RequestItemPlace();
    }
}
