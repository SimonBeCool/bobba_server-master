...
public class RoomUser {
    ...
    public void furniMove(int furniid,int x,int y,int rotation) {
        if (room != null) {
            room.getRoomItemManager().moveTo(furniid, x, y, rotation);
        }
    }
    ...
    public void InventarRemove(int furniid) {
        room.getRoomItemManager().InvRemove(furniid); 
    }
    
    public void furniRemove(int itemId) {
        if (room != null) {
            room.getRoomItemManager().removeItem(itemId);
        }
    }
    
    public void furniaddInventory(int itemId) {
        if (room != null) {
            room.getRoomItemManager().addInventoryItem(itemId);
        }
    }
    ...
    public void userLook(String look, String gender) {
